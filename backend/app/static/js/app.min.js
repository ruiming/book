...
var notie = function () {
  ...
  }angular.module("index", ["ui.router", "ui.bootstrap", "ngAnimate", "ngSanitize", "ngTouch", "angularPromiseButtons", "infinite-scroll"]).config(t).run(["$state", "$rootScope", function (t, e) {
