    ...
    function booklistservice($http, $q) {
        ...
        function getBooklistDetail(id) {
            if (booklist[id] === void 0) {
                return $http.get(host + '/booklist?id=' + id).then(function (response) {
...
(function () {
    ...
    function bookservice($http, commonservice, $q) {
        ...
        function getPopularBooks2() {
            if (popBooks === null) {
                return $http.get(host + '/pop_book').then(function (response) {
        ...
        function getBookDetail(isbn) {
            if (bookDetail[isbn] === void 0) {
                return $http.get(host + '/book?type=detail&isbn=' + isbn).then(function (response) {
        ...
        function getBookBelongs(isbn) {
            return $http.get(host + '/booklist?isbn=' + isbn).then(function (response) {
                return response.data;
            });
        }
        ...
        function getSimilarBook(isbn) {
            if (similarBook[isbn] == null) {
                return $http.get(host + '/similar_book?isbn=' + isbn).then(function (response) {
...
(function () {
    ...
    function slideservice($http, $q) {
        ...
        function getSlides() {
            if (slides === null) {
                return $http.get(host + '/slides').then(function (response) {
...
(function () {
    ...
    function tagservice($http, $q) {
        ...
        function getAllTags() {
            if (allTags == null) {
                return $http.get(host + '/tags?type=all').then(function (response) {
        ...
        function getHotTags() {
            if (hotTags == null) {
                return $http.get(host + '/tags?type=hot').then(function (response) {
    ...
    function userservice($http, commonservice, $q) {
        ...
        function getUserDefaultAddress() {
            if (defaultAddress == null) {
                return $http.get(host + '/user_address?type=default').then(function (response) {
        ...
        function getUserInfo() {
            if (userInfo == null) {
                return $http.get(host + '/user_info').then(function (response) {
...
(function () {
    ...
    function BookCtrl($stateParams, commentservice, bookservice, cartservice, userservice) {
        ...
        bookservice.getBook($stateParams.isbn).then(function (response) {
            vm.book = response;
...
(function () {
    ...
    function BookInfoCtrl(bookservice, $stateParams) {
        ...
        function getBookDetail() {
            bookservice.getBookDetail($stateParams.isbn).then(function (response) {
                vm.book = response;
            });
        }
    }
...
(function () {
    ...
    function BookListCtrl($stateParams, booklistservice) {
        ...
        function getBooklistDetail() {
            booklistservice.getBooklistDetail($stateParams.id).then(function (response) {
                ...
                try {
                    for (var _iterator2 = vm.booklist.books[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
(function () {
    ...
    function BooklistsCtrl(booklistservice, tagservice) {
        ...
        function getHotTags() {
            tagservice.getHotTags().then(function (response) {
                vm.tags = response;
            });
        }
    ...
    function CartCtrl($state, cartservice, bookservice, orderservice) {
        ...
        function getCart() {
            cartservice.getCart().then(function (response) {
                ...
                try {
                    for (var _iterator3 = vm.items[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
        ...
        function recount() {
            ...
            try {
                for (var _iterator4 = vm.items[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        function selectAll() {
            ...
            try {
                for (var _iterator5 = vm.items[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
...
(function () {
    ...
    function Cart2OrderCtrl($location, userservice, orderservice) {
        ...
        try {
            for (var _iterator11 = vm.books[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                var book = _step11.value;
...
(function () {
    ...
    function CollectBookListsCtrl(userservice) {
        ...
        function getUserCollect() {
            userservice.getUserCollect('booklist').then(function (response) {
                vm.booklists = response;
            });
        }
    }
...
(function () {
    ...
    function CollectBooksCtrl(userservice, bookservice) {
        ...
        function getUserCollect() {
            userservice.getUserCollect('book').then(function (response) {
                vm.books = response;
                ...
                try {
                    for (var _iterator12 = vm.books[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
                        var book = _step12.value;
...
(function () {
    ...
    function NoticesCtrl(userservice) {
        ...
        function getUserNotices() {
            userservice.getUserNotices().then(function (response) {
                vm.notices = response;
            });
        }
    }
    ...
    function OrderCommentsCtrl($q, $stateParams, orderservice, commentservice) {
        ...
        function comment() {
            ...
            if (!vm.commentForm.$valid) {
                ...
                try {
                    for (var _iterator13 = vm.order.carts[Symbol.iterator](), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
                        var z = _step13.value;
    ...
    function OrderDetailCtrl($stateParams, orderservice) {
        ...
        function getOrderDetail() {
            orderservice.getOrderDetail($stateParams.id).then(function (response) {
                ...
                try {
                    for (var _iterator15 = vm.order.status_list[Symbol.iterator](), _step15; !(_iteratorNormalCompletion15 = (_step15 = _iterator15.next()).done); _iteratorNormalCompletion15 = true) {
...
(function () {
    ...
    function OrdersCtrl($stateParams, orderservice) {
        ...
        function getOrder() {
            orderservice.getOrder($stateParams.status).then(function (response) {
                vm.orders = response;
                ...
                try {
                    for (var _iterator16 = vm.orders[Symbol.iterator](), _step16; !(_iteratorNormalCompletion16 = (_step16 = _iterator16.next()).done); _iteratorNormalCompletion16 = true) {
...
(function () {
    ...
    function AddressCtrl($state, userservice) {
        ...
        function getUserAddress() {
            userservice.getUserAddress().then(function (response) {
                vm.address = response;
            });
        }
