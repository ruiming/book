...
(function () {
    ...
    angular.module('index', ['ui.router', 'ui.bootstrap', 'ngAnimate', 'ngSanitize', 'ngTouch', 'angularPromiseButtons', 'infinite-scroll']).config(config).run(["$state", "$rootScope", function ($state, $rootScope) {
        ...
        $stateProvider.state('index', {
            ...
            resolve: {
                ...
                booklists: ["booklistservice", function (booklistservice) {
                    return booklistservice.getBooklists(1, 'all').then(function (response) {
                        return response;
                    });
                }]
            }
            ...
            resolve: {
                books: ["bookservice", function (bookservice) {
                    return bookservice.getBooks(1).then(function (response) {
                        return response;
                    });
                }]
            }
            ...
            resolve: {
                booklists: ["booklistservice", function (booklistservice) {
                    return booklistservice.getBooklists(1).then(function (response) {
                        return response;
                    });
                }]
            }
            ...
            resolve: {
                booklists: ["booklistservice", "$stateParams", function (booklistservice, $stateParams) {
                    return booklistservice.getBooklists(1, 'all', $stateParams.tag).then(function (response) {
                        return response;
                    });
                }]
            }
...
(function () {
    ...
    function bookservice($http, commonservice, $q) {
        ...
        function getBooks(page) {
            return $http.get(host + '/pop_book?page=' + page).then(function (response) {
                return changeStars(response.data);
            });
        }
...
(function () {
    ...
    function BooklistsCtrl(booklistservice, tags, booklists) {
        ...
        function more() {
            if (page !== null) {
                return booklistservice.getBooklists(++page, type).then(function (response) {
        ...
        function getBooklistOrderByTime() {
            return booklistservice.getBooklists(1, 'time').then(function (response) {
                vm.booklists = response;
                page = 1;
                type = 'time';
            });
        ...
        function getBooklistOrderByCollect() {
            return booklistservice.getBooklists(1, 'collect').then(function (response) {
                vm.booklists = response;
                page = 1;
                type = 'time';
            });
...
(function () {
    ...
    function PopularMoreCtrl(booklists, booklistservice) {
        ...
        function more() {
            if (page !== null) {
                return booklistservice.getBooklists(++page).then(function (response) {
                    if (response.length === 0) {
                        page = null;
                    } else {
                        Array.prototype.push.apply(vm.booklists, response);
...
(function () {
    ...
    function RecommendMoreCtrl(books, bookservice) {
        ...
        function more() {
            if (page !== null) {
                return bookservice.getBooks(++page).then(function (response) {
                    if (response.length === 0) {
                        page = null;
                    } else {
...
(function () {
    ...
    function TagBooklistsCtrl($stateParams, booklistservice, booklists) {
        ...
        function more() {
            if (page !== null) {
                return booklistservice.getBooklists(++page, type, tag).then(function (response) {
                    if (response.length === 0) {
                        page = null;
                    } else {
                        Array.prototype.push.apply(vm.booklists, response);
        ...
        function getBooklistOrderByTime() {
            return booklistservice.getBooklists(1, 'time', tag).then(function (response) {
                vm.booklists = response;
                page = 1;
                type = 'time';
            });
        ...
        function getBooklistOrderByCollect() {
            return booklistservice.getBooklists(1, 'collect', tag).then(function (response) {
                vm.booklists = response;
                page = 1;
                type = 'time';
            });
...
angular.module('index').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('booklists/booklists_slides_part.html', '<div class="booklists"><div class="btn-group order"><button class="btn btn-default" ng-click="vm.timeOrder()">时间优先</button> <button class="btn btn-default" ng-click="vm.collectOrder()">收藏优先</button></div><booklist-row booklists="vm.booklists" more="vm.more"></booklist-row></div>');
  ...
  $templateCache.put('popular_more/popular_more_tpl.html', '<div class="popular-more-page"><booklist-row booklists="vm.booklists" more="vm.more"></booklist-row></div>');

  $templateCache.put('recommend_more/recommend_more_tpl.html', '<div class="recommend-more-page" style="overflow: hidden;"><book-row books="vm.books" more="vm.more"></book-row></div>');
